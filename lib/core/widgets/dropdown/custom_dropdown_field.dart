      ...
      child: Expanded(
        child: DropdownButtonFormField<T>(
          ...
          icon: suffixIcon != null
              ? Icon(suffixIcon, color: suffixIconColor ?? AppColors.dark)
              : null,
          decoration: InputDecoration(
            prefixIcon: prefixIcon != null
                ? Icon(prefixIcon, color: prefixIconColor ?? AppColors.darkGrey)
                : null,
            hintText: hintText,
          ...
          dropdownColor: dropdownColor ?? AppColors.dark,
        ),
      ),
    );
  }
